...
public class ContiuousDictationFragment extends Fragment implements RecognitionListener{
    // ----- INTERFACES ----- //
    ...
    public interface ContinuousDictationFragmentResultsCallback {
        ...
        public void onResults(ContiuousDictationFragment delegate, ArrayList<String> dictationResults);
    ...
    // Logger tag
    private static final String TAG = "" + ContiuousDictationFragment.class;
     ...
     * Default constructor
     */
    public ContiuousDictationFragment() {
    }
